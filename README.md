...
![Example Image](ex_screenshot.png)


<br>

Two recommendations if you plan to use this yourself:
 * Use the 'Flip Orientation' button to use the app with your Kindle upside down and have easy access to the charging for uninterrupted use
